    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 relative overflow-hidden">
      ...
      <header className="container mx-auto px-4 py-16 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto leading-relaxed font-pixel">
      ...
      <section className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-4xl font-bold text-white text-center mb-16 font-xerxes">
            Game Features
          </h3>
      ...
      <footer className="border-t border-slate-700 bg-slate-900/50 relative z-10">
        <div className="container mx-auto px-4 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              >
                ...
                <span className="font-pixel">Twitter</span>
              </a>
              <a
              ...
              >
                ...
                <span className="font-pixel">Telegram</span>
              </a>
              <a
          ...
          <div className="mt-8 pt-8 border-t border-slate-700 text-center text-slate-400">
            <p className="font-pixel">&copy; 2024 POW! - Keep Starknet Strange. Built by the Exploration Team.</p>
          </div>
        </div>
      </footer>
    </div>
